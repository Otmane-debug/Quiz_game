...
class Menu:
    def __init__(self, f):
        ...
        self.strt.pack(pady=4)
        self.scores.pack(pady=4)
        self.qui.pack(pady=4)
...
class Player_start:
    ...
    def subs(self, n):
        ...
        if n.get():
            ...
            player_name = "anonymous-" + str(anc_an)
            anc_an += 1
...
class History:
    def __init__(self, f):
        ...
        self.text = Label(self.frame_m, text="Rank", pady=8, font=("Arial", 15), width=30)
        self.text.grid(row=0,  column=0, columnspan=2, pady=8)
                
        self.first = Label(self.frame_m, text="Name :", bg="#FF8C00", font=("Arial", 11, "bold"))
        self.first_s = Label(self.frame_m, text="Score :", bg="#FF8C00", font=("Arial", 11, "bold"))
        
        self.first.grid(row=1, column=0)
        self.first_s.grid(row=1, column=1)    
        ...
        for k in self.sorted_data:
            ...
            self.nom = Label(self.frame_m, text=k, bg="#FF8C00", font=("Arial", 10))
            self.res = Label(self.frame_m, text=self.dic_data[k], bg="#FF8C00", font=("Arial", 10))
            
            self.nom.grid(row=self.i, column=0)
            self.res.grid(row=self.i, column=1)
        ...
        self.men.grid(row=8, column=0,columnspan=2, pady=8)
        self.qui.grid(row=9, column=0,columnspan=2)
